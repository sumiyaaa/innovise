...
//   return (
//     <section className="py-24 px-6  bg-gradient-to-tr from-[#e0f7fa] via-[#e3f2fd] to-[#e0f7fa]  text-[#8CC63F]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {values.map((value, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              variants={cardVariants}
              className="relative bg-white rounded-xl p-6 border-l-4 shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl group overflow-hidden"
              style={{ borderLeftColor: value.color }}
            >
              {/* Top Bar Animation */}
              <span
